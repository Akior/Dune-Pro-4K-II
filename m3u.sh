...
#   get kp id
    guess_kp=$(curl -k --silent -G "https://kinopoiskapiunofficial.tech/api/v2.1/films/search-by-keyword" --data-urlencode "keyword=$rev_name" -H "accept: application/json" -H "X-API-KEY: $KEY" | jq -r '.films[0].filmId')
